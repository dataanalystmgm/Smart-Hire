          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-8 overflow-y-auto custom-scrollbar flex-1">
                    ...
                    <div className="space-y-4">
                      <div className="bg-white p-6 rounded-xl border border-slate-200">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center text-mgm-dark font-bold text-lg">
                            <CheckCircle className="w-6 h-6 text-mgm-green mr-2" />
                            Hasil Analisis
                          </div>
                          <div className={`px-4 py-1.5 rounded-full font-bold ${parseInt(matchResult.score) < 60 ? 'bg-amber-100 text-amber-700' : 'bg-mgm-dark text-white'}`}>
                        ...
                        <button 
                          ...
                          className="text-sm font-bold text-mgm-green hover:underline"
                        >
                      ...
                      {parseInt(matchResult.score) < 60 && (
                        <div className="flex items-start text-sm text-amber-800 bg-amber-50 p-4 rounded-xl border border-amber-200">
                ...
                <div className="mt-8 flex items-start text-sm text-slate-500 bg-blue-50/50 p-4 rounded-xl border border-blue-100">
